  ...
  return <div className="fixed top-0 bottom-0 left-0 right-0 overflow-hidden" ref={eventArea}>
    <div ref={ref} style={{transformOrigin: '0 0'}}>
      <div className='flex flex-col items-center gap-24px'>
        ...
        <div style={{boxShadow: '0px 0px 20px 6px rgba(0,0,0,0.2)'}}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 720" shapeRendering="crispEdges" width="450" height="720">
            ...
            <g fontWeight="700" fontFamily="微软雅黑" fill="#000000">
              ...
              <text x="36" y="106" fontSize="22">采购订单:5410798389</text>

              <text x="36" y="146" fontSize="22">物料号:20402008</text>

              <text x="36" y="186" fontSize="22">X02侧碰支架上板(左)/076</text>
              <text x="36" y="212" fontSize="22">-FSFL4052</text>

              <text x="36" y="252" fontSize="22">生产日期:20001122</text>

              <text x="36" y="292" fontSize="22">批次:24091442</text>

              <text x="36" y="332" fontSize="22">炉号:24091442</text>
              <text x="233" y="332" fontSize="22">数量:2409pcs</text>

              <text x="36" y="372" fontSize="22">供应商:24091442(123)</text>

              <text x="36" y="412" fontSize="22">生产地址:</text>

              <text x="36" y="452" fontSize="22">追溯号:123897236487629</text>
            </g>
        ...
        <div style={{boxShadow: '0px 0px 20px 6px rgba(0,0,0,0.2)'}}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 500" shapeRendering="crispEdges" width="450" height="500">
            ...
            <g fontWeight="700" fontFamily="微软雅黑" fill="#000000">
              ...
              <text x="436" y="144" fontSize="15" textAnchor="end">TX24100800001</text>
        ...
        <div style={{boxShadow: '0px 0px 20px 6px rgba(0,0,0,0.2)'}}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 240" shapeRendering="crispEdges" width="450" height="240">
            <rect x="0" y="0" width="450" height="240" fill="#ffffff" />

            <rect x="4" y="4" width="442" height="232" fill="#ffffff" stroke='#000000' strokeWidth='1' />

            <line x1='4' y1='96' x2='446' y2='96' stroke='#000000' strokeWidth='1' />
            <line x1='4' y1='119' x2='446' y2='119' stroke='#000000' strokeWidth='1' />
            <line x1='4' y1='142' x2='446' y2='142' stroke='#000000' strokeWidth='1' />
            <line x1='4' y1='165' x2='336' y2='165' stroke='#000000' strokeWidth='1' />
            <line x1='4' y1='188' x2='336' y2='188' stroke='#000000' strokeWidth='1' />
            <line x1='4' y1='211' x2='336' y2='211' stroke='#000000' strokeWidth='1' />

            <line x1='64' y1='96' x2='64' y2='236' stroke='#000000' strokeWidth='1' />
            <line x1='336' y1='96' x2='336' y2='236' stroke='#000000' strokeWidth='1' />
            <line x1='260' y1='96' x2='260' y2='142' stroke='#000000' strokeWidth='1' />
            <line x1='206' y1='119' x2='206' y2='142' stroke='#000000' strokeWidth='1' />
            <line x1='386' y1='119' x2='386' y2='142' stroke='#000000' strokeWidth='1' />
            <line x1='170' y1='165' x2='170' y2='236' stroke='#000000' strokeWidth='1' />
            <line x1='230' y1='165' x2='230' y2='236' stroke='#000000' strokeWidth='1' />
            <line x1='124' y1='188' x2='124' y2='211' stroke='#000000' strokeWidth='1' />
            <line x1='270' y1='188' x2='270' y2='211' stroke='#000000' strokeWidth='1' />
