    ...
    <div ref={ref} style={{ transformOrigin: '0 0' }}>
      <div className='flex flex-col items-center gap-24px'>
        ...
        <div style={{ boxShadow: '0px 0px 20px 6px rgba(0,0,0,0.2)' }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 225" shapeRendering="crispEdges" width="200mm" height="100mm">
            ...
            <svg x="372" y="8" width="70" height="70" shapeRendering="crispEdges" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25">
            ...
            <g fontWeight="800" fontFamily="微软雅黑" fill="#000000">
              <text x="225" y="45" dominantBaseline="middle" textAnchor="middle" fontSize="24">产品标识卡</text>
              ...
              <text x='85' y='144' fontSize='16' transform='scale(0.8, 1)'>{"${data.ProductSpec ?? ''}"}</text>
              ...
              <text x='85' y='190' fontSize='16' transform='scale(0.8, 1)'>{"${data.Amount ?? ''}"}</text>
        ...
        <div style={{ boxShadow: '0px 0px 20px 6px rgba(0,0,0,0.2)' }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 500" shapeRendering="crispEdges" width="90mm" height="100mm">
            <rect x="0" y="0" width="450" height="500" fill="#ffffff" />

            <svg x="329" y="16" width="105" height="105" shapeRendering="crispEdges" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25">
              <rect width="25" height="25" fill="#ffffff"></rect>
              <path
                fill="#000000"
                d="M0 0h7v1H0zM8 0h2v1H8zM11 0h1v1H11zM14 0h1v1H14zM18,0 h7v1H18zM0 1h1v1H0zM6 1h1v1H6zM8 1h2v1H8zM12 1h1v1H12zM16 1h1v1H16zM18 1h1v1H18zM24,1 h1v1H24zM0 2h1v1H0zM2 2h3v1H2zM6 2h1v1H6zM9 2h3v1H9zM14 2h3v1H14zM18 2h1v1H18zM20 2h3v1H20zM24,2 h1v1H24zM0 3h1v1H0zM2 3h3v1H2zM6 3h1v1H6zM8 3h1v1H8zM10 3h1v1H10zM18 3h1v1H18zM20 3h3v1H20zM24,3 h1v1H24zM0 4h1v1H0zM2 4h3v1H2zM6 4h1v1H6zM8 4h2v1H8zM12 4h1v1H12zM14 4h1v1H14zM18 4h1v1H18zM20 4h3v1H20zM24,4 h1v1H24zM0 5h1v1H0zM6 5h1v1H6zM8 5h1v1H8zM10 5h1v1H10zM12 5h2v1H12zM18 5h1v1H18zM24,5 h1v1H24zM0 6h7v1H0zM8 6h1v1H8zM10 6h1v1H10zM12 6h1v1H12zM14 6h1v1H14zM16 6h1v1H16zM18,6 h7v1H18zM9 7h1v1H9zM12 7h4v1H12zM3 8h1v1H3zM6 8h1v1H6zM9 8h2v1H9zM12 8h2v1H12zM15 8h1v1H15zM19 8h3v1H19zM23,8 h2v1H23zM4 9h1v1H4zM8 9h5v1H8zM17 9h1v1H17zM19 9h2v1H19zM22 9h1v1H22zM24,9 h1v1H24zM0 10h3v1H0zM5 10h3v1H5zM9 10h2v1H9zM13 10h1v1H13zM15 10h2v1H15zM18 10h3v1H18zM0 11h1v1H0zM2 11h3v1H2zM10 11h1v1H10zM16 11h1v1H16zM19 11h3v1H19zM0 12h2v1H0zM3 12h6v1H3zM11 12h2v1H11zM14 12h2v1H14zM18 12h1v1H18zM20 12h1v1H20zM22 12h1v1H22zM24,12 h1v1H24zM1 13h1v1H1zM3 13h2v1H3zM10 13h1v1H10zM15 13h3v1H15zM21 13h1v1H21zM23,13 h2v1H23zM0 14h1v1H0zM3 14h2v1H3zM6 14h3v1H6zM10 14h1v1H10zM14 14h1v1H14zM21 14h1v1H21zM23 14h1v1H23zM1 15h1v1H1zM5 15h1v1H5zM7 15h1v1H7zM10 15h4v1H10zM15 15h1v1H15zM17 15h3v1H17zM24,15 h1v1H24zM0 16h2v1H0zM3 16h2v1H3zM6 16h2v1H6zM9 16h2v1H9zM16 16h5v1H16zM24,16 h1v1H24zM8 17h1v1H8zM11 17h3v1H11zM15 17h2v1H15zM20 17h2v1H20zM23 17h1v1H23zM0 18h7v1H0zM9 18h2v1H9zM12 18h1v1H12zM14 18h1v1H14zM16 18h1v1H16zM18 18h1v1H18zM20 18h1v1H20zM22 18h2v1H22zM0 19h1v1H0zM6 19h1v1H6zM11 19h1v1H11zM13 19h2v1H13zM16 19h1v1H16zM20 19h1v1H20zM22,19 h3v1H22zM0 20h1v1H0zM2 20h3v1H2zM6 20h1v1H6zM10 20h1v1H10zM12 20h2v1H12zM15 20h6v1H15zM22 20h1v1H22zM24,20 h1v1H24zM0 21h1v1H0zM2 21h3v1H2zM6 21h1v1H6zM8 21h1v1H8zM11 21h2v1H11zM14 21h3v1H14zM18 21h2v1H18zM21 21h1v1H21zM23 21h1v1H23zM0 22h1v1H0zM2 22h3v1H2zM6 22h1v1H6zM9 22h1v1H9zM12 22h2v1H12zM15 22h2v1H15zM18 22h3v1H18zM24,22 h1v1H24zM0 23h1v1H0zM6 23h1v1H6zM9 23h2v1H9zM14 23h1v1H14zM19 23h3v1H19zM24,23 h1v1H24zM0 24h7v1H0zM9 24h1v1H9zM11 24h1v1H11zM16 24h3v1H16zM20 24h1v1H20zM22 24h1v1H22zM24,24 h1v1H24z"
            ...
            <g fontWeight="800" fontFamily="微软雅黑" fill="#000000">
              <text x="225" y="28" dominantBaseline="middle" textAnchor="middle" fontSize="16">宁波途兴汽车部件有限公司</text>
              ...
              <text x="132" y="276" fontSize="22" transform='scale(0.8, 1)'>{"${data.Amount ?? ''}"}</text>
        ...
        <div style={{ boxShadow: '0px 0px 20px 6px rgba(0,0,0,0.2)' }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 500" shapeRendering="crispEdges" width="90mm" height="100mm">
            ...
            <g fontWeight="800" fontFamily="微软雅黑" fill="#000000">
              ...
              <text x="132" y="356" fontSize="20" transform='scale(0.8, 1)'>{"${data.Amount ?? ''}"}</text>
        ...
        <div style={{ boxShadow: '0px 0px 20px 6px rgba(0,0,0,0.2)' }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 500" shapeRendering="crispEdges" width="90mm" height="100mm">
            ...
            <g fontWeight="800" fontFamily="微软雅黑" fill="#000000">
              ...
              <text x="20" y="168" fontSize="16">生产车间</text>
              <text x="94" y="168" fontSize="14">{"${data.WorkshopName ?? ''}"}</text>
              <line x1="94" y1="172" x2="236" y2="172" stroke="#000000" strokeWidth="2"></line>
              <text x="240" y="168" fontSize="16">班次</text>
              <text x="276" y="168" fontSize="14">{"${data.ShiftName ?? ''}"}</text>
              <line x1="276" y1="172" x2="410" y2="172" stroke="#000000" strokeWidth="2"></line>
              <text x="20" y="204" fontSize="16">产品名称</text>
              <text x="116" y="204" fontSize="16" transform="scale(0.8, 1)">{"${data.ProductName ?? ''}"}</text>
              <line x1="94" y1="208" x2="410" y2="208" stroke="#000000" strokeWidth="2"></line>
              <text x="20" y="242" fontSize="16">产品规格</text>
              <text x="116" y="242" fontSize="20" transform="scale(0.8, 1)">{"${data.ProductSpec ?? ''}"}</text>
              <line x1="94" y1="246" x2="410" y2="246" stroke="#000000" strokeWidth="2"></line>
              <text x="20" y="280" fontSize="16">图号</text>
              <text x="94" y="280" fontSize="14">{"${data.ProductDrawingNumber ?? ''}"}</text>
              <line x1="94" y1="284" x2="236" y2="284" stroke="#000000" strokeWidth="2"></line>
              <text x="240" y="280" fontSize="16">数量</text>
              <text x="346" y="280" fontSize="20" transform='scale(0.8, 1)'>{"${data.Amount ?? ''}"}</text>
              <line x1="276" y1="284" x2="410" y2="284" stroke="#000000" strokeWidth="2"></line>
              <text x="20" y="320" fontSize="16">生产批次</text>
              <text x="94" y="320" fontSize="14">{"${data.Lot ?? ''}"}</text>
              <line x1="94" y1="324" x2="236" y2="324" stroke="#000000" strokeWidth="2"></line>
              <text x="240" y="320" fontSize="16">钢印号</text>
              <text x="294" y="320" fontSize="14">{"${data.SteelSealNumber ?? ''}"}</text>
              <line x1="294" y1="324" x2="410" y2="324" stroke="#000000" strokeWidth="2"></line>
              <text x="20" y="362" fontSize="16">本道工序</text>
              <text x="94" y="362" fontSize="14">{"${data.CurrentProcessName ?? ''}"}</text>
              <line x1="94" y1="366" x2="410" y2="366" stroke="#000000" strokeWidth="2"></line>
              <text x="20" y="400" fontSize="16">下道工序</text>
              <text x="94" y="400" fontSize="14">{"${data.NextProcessName ?? ''}"}</text>
              <line x1="94" y1="404" x2="410" y2="404" stroke="#000000" strokeWidth="2"></line>
              <text x="20" y="438" fontSize="16">操作工</text>
              <text x="94" y="438" fontSize="14">{"${data.UserName ?? ''}"}</text>
              <line x1="94" y1="442" x2="410" y2="442" stroke="#000000" strokeWidth="2"></line>
              <text x="20" y="476" fontSize="16">生产日期</text>
              <text x="94" y="476" fontSize="14">{"${data.ProductionDate ?? ''}"}</text>
              <line x1="94" y1="480" x2="236" y2="480" stroke="#000000" strokeWidth="2"></line>
              <text x="240" y="476" fontSize="16">检验结论</text>
              <text x="308" y="476" fontSize="14">{"${data.Result ?? ''}"}</text>
              <line x1="308" y1="480" x2="410" y2="480" stroke="#000000" strokeWidth="2"></line>
            </g>
          </svg>
        </div>
        ...
        <div style={{ boxShadow: '0px 0px 20px 6px rgba(0,0,0,0.2)' }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 500" shapeRendering="crispEdges" width="90mm" height="100mm">
            ...
            <g fontWeight="800" fontFamily="微软雅黑" fill="#000000">
              ...
              <text x="240" y="224" fontSize="16">产品规格</text>
              <text x="382" y="224" fontSize="20" transform='scale(0.8, 1)'>{"${data.ProductSpec ?? ''}"}</text>
              ...
              <text x="118" y="368" fontSize="18" transform='scale(0.8, 1)'>{"${data.Amount ?? ''}"}</text>
        ...
        <div style={{ boxShadow: '0px 0px 20px 6px rgba(0,0,0,0.2)' }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 500" shapeRendering="crispEdges" width="90mm" height="100mm">
            ...
            <g fontWeight="800" fontFamily="微软雅黑" fill="#000000">
              ...
              <text x="242" y="230" fontSize="16">规格</text>
              <text x="346" y="230" fontSize="18" transform='scale(0.8, 1)'>{"${data.ProductSpec ?? ''}"}</text>
        ...
        <div style={{ boxShadow: '0px 0px 20px 6px rgba(0,0,0,0.2)' }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 306" shapeRendering="crispEdges" width="147mm" height="100mm">
            <rect x="0" y="0" width="450" height="306" fill="#ffffff" />

            <svg x="20" y="20" width="90" height="90" shapeRendering="crispEdges" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25">
              <rect width="25" height="25" fill="#ffffff"></rect>
              <path
                fill="#000000"
                d="M0 0h7v1H0zM8 0h2v1H8zM11 0h1v1H11zM14 0h1v1H14zM18,0 h7v1H18zM0 1h1v1H0zM6 1h1v1H6zM8 1h2v1H8zM12 1h1v1H12zM16 1h1v1H16zM18 1h1v1H18zM24,1 h1v1H24zM0 2h1v1H0zM2 2h3v1H2zM6 2h1v1H6zM9 2h3v1H9zM14 2h3v1H14zM18 2h1v1H18zM20 2h3v1H20zM24,2 h1v1H24zM0 3h1v1H0zM2 3h3v1H2zM6 3h1v1H6zM8 3h1v1H8zM10 3h1v1H10zM18 3h1v1H18zM20 3h3v1H20zM24,3 h1v1H24zM0 4h1v1H0zM2 4h3v1H2zM6 4h1v1H6zM8 4h2v1H8zM12 4h1v1H12zM14 4h1v1H14zM18 4h1v1H18zM20 4h3v1H20zM24,4 h1v1H24zM0 5h1v1H0zM6 5h1v1H6zM8 5h1v1H8zM10 5h1v1H10zM12 5h2v1H12zM18 5h1v1H18zM24,5 h1v1H24zM0 6h7v1H0zM8 6h1v1H8zM10 6h1v1H10zM12 6h1v1H12zM14 6h1v1H14zM16 6h1v1H16zM18,6 h7v1H18zM9 7h1v1H9zM12 7h4v1H12zM3 8h1v1H3zM6 8h1v1H6zM9 8h2v1H9zM12 8h2v1H12zM15 8h1v1H15zM19 8h3v1H19zM23,8 h2v1H23zM4 9h1v1H4zM8 9h5v1H8zM17 9h1v1H17zM19 9h2v1H19zM22 9h1v1H22zM24,9 h1v1H24zM0 10h3v1H0zM5 10h3v1H5zM9 10h2v1H9zM13 10h1v1H13zM15 10h2v1H15zM18 10h3v1H18zM0 11h1v1H0zM2 11h3v1H2zM10 11h1v1H10zM16 11h1v1H16zM19 11h3v1H19zM0 12h2v1H0zM3 12h6v1H3zM11 12h2v1H11zM14 12h2v1H14zM18 12h1v1H18zM20 12h1v1H20zM22 12h1v1H22zM24,12 h1v1H24zM1 13h1v1H1zM3 13h2v1H3zM10 13h1v1H10zM15 13h3v1H15zM21 13h1v1H21zM23,13 h2v1H23zM0 14h1v1H0zM3 14h2v1H3zM6 14h3v1H6zM10 14h1v1H10zM14 14h1v1H14zM21 14h1v1H21zM23 14h1v1H23zM1 15h1v1H1zM5 15h1v1H5zM7 15h1v1H7zM10 15h4v1H10zM15 15h1v1H15zM17 15h3v1H17zM24,15 h1v1H24zM0 16h2v1H0zM3 16h2v1H3zM6 16h2v1H6zM9 16h2v1H9zM16 16h5v1H16zM24,16 h1v1H24zM8 17h1v1H8zM11 17h3v1H11zM15 17h2v1H15zM20 17h2v1H20zM23 17h1v1H23zM0 18h7v1H0zM9 18h2v1H9zM12 18h1v1H12zM14 18h1v1H14zM16 18h1v1H16zM18 18h1v1H18zM20 18h1v1H20zM22 18h2v1H22zM0 19h1v1H0zM6 19h1v1H6zM11 19h1v1H11zM13 19h2v1H13zM16 19h1v1H16zM20 19h1v1H20zM22,19 h3v1H22zM0 20h1v1H0zM2 20h3v1H2zM6 20h1v1H6zM10 20h1v1H10zM12 20h2v1H12zM15 20h6v1H15zM22 20h1v1H22zM24,20 h1v1H24zM0 21h1v1H0zM2 21h3v1H2zM6 21h1v1H6zM8 21h1v1H8zM11 21h2v1H11zM14 21h3v1H14zM18 21h2v1H18zM21 21h1v1H21zM23 21h1v1H23zM0 22h1v1H0zM2 22h3v1H2zM6 22h1v1H6zM9 22h1v1H9zM12 22h2v1H12zM15 22h2v1H15zM18 22h3v1H18zM24,22 h1v1H24zM0 23h1v1H0zM6 23h1v1H6zM9 23h2v1H9zM14 23h1v1H14zM19 23h3v1H19zM24,23 h1v1H24zM0 24h7v1H0zM9 24h1v1H9zM11 24h1v1H11zM16 24h3v1H16zM20 24h1v1H20zM22 24h1v1H22zM24,24 h1v1H24z"
            ...
            <g fontWeight="800" fontFamily="微软雅黑" fill="#000000">
              ...
              <text x="210" y="154" fontSize="16">规格</text>
              <text x="314" y="154" fontSize="18" transform='scale(0.8, 1)'>{"${data.ProductSpec ?? ''}"}</text>
              ...
              <text x="82" y="234" fontSize="18" transform='scale(0.8, 1)'>{"${data.Amount ?? ''}"}</text>
              ...
              <text x="394" y="116" fontSize="24">建</text>
              <text x="394" y="156" fontSize="24">新</text>
              <text x="394" y="196" fontSize="24">赵</text>
              <text x="394" y="236" fontSize="24">氏</text>
            </g>
          </svg>
        </div>
        ...
        <div style={{ boxShadow: '0px 0px 20px 6px rgba(0,0,0,0.2)' }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 306" shapeRendering="crispEdges" width="147mm" height="100mm">
            ...
            <svg x="24" y="14" width="37" height="37" shapeRendering="crispEdges" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25">
              <rect width="25" height="25" fill="#ffffff"></rect>
              <path
                fill="#000000"
                d="M0 0h7v1H0zM8 0h2v1H8zM11 0h1v1H11zM14 0h1v1H14zM18,0 h7v1H18zM0 1h1v1H0zM6 1h1v1H6zM8 1h2v1H8zM12 1h1v1H12zM16 1h1v1H16zM18 1h1v1H18zM24,1 h1v1H24zM0 2h1v1H0zM2 2h3v1H2zM6 2h1v1H6zM9 2h3v1H9zM14 2h3v1H14zM18 2h1v1H18zM20 2h3v1H20zM24,2 h1v1H24zM0 3h1v1H0zM2 3h3v1H2zM6 3h1v1H6zM8 3h1v1H8zM10 3h1v1H10zM18 3h1v1H18zM20 3h3v1H20zM24,3 h1v1H24zM0 4h1v1H0zM2 4h3v1H2zM6 4h1v1H6zM8 4h2v1H8zM12 4h1v1H12zM14 4h1v1H14zM18 4h1v1H18zM20 4h3v1H20zM24,4 h1v1H24zM0 5h1v1H0zM6 5h1v1H6zM8 5h1v1H8zM10 5h1v1H10zM12 5h2v1H12zM18 5h1v1H18zM24,5 h1v1H24zM0 6h7v1H0zM8 6h1v1H8zM10 6h1v1H10zM12 6h1v1H12zM14 6h1v1H14zM16 6h1v1H16zM18,6 h7v1H18zM9 7h1v1H9zM12 7h4v1H12zM3 8h1v1H3zM6 8h1v1H6zM9 8h2v1H9zM12 8h2v1H12zM15 8h1v1H15zM19 8h3v1H19zM23,8 h2v1H23zM4 9h1v1H4zM8 9h5v1H8zM17 9h1v1H17zM19 9h2v1H19zM22 9h1v1H22zM24,9 h1v1H24zM0 10h3v1H0zM5 10h3v1H5zM9 10h2v1H9zM13 10h1v1H13zM15 10h2v1H15zM18 10h3v1H18zM0 11h1v1H0zM2 11h3v1H2zM10 11h1v1H10zM16 11h1v1H16zM19 11h3v1H19zM0 12h2v1H0zM3 12h6v1H3zM11 12h2v1H11zM14 12h2v1H14zM18 12h1v1H18zM20 12h1v1H20zM22 12h1v1H22zM24,12 h1v1H24zM1 13h1v1H1zM3 13h2v1H3zM10 13h1v1H10zM15 13h3v1H15zM21 13h1v1H21zM23,13 h2v1H23zM0 14h1v1H0zM3 14h2v1H3zM6 14h3v1H6zM10 14h1v1H10zM14 14h1v1H14zM21 14h1v1H21zM23 14h1v1H23zM1 15h1v1H1zM5 15h1v1H5zM7 15h1v1H7zM10 15h4v1H10zM15 15h1v1H15zM17 15h3v1H17zM24,15 h1v1H24zM0 16h2v1H0zM3 16h2v1H3zM6 16h2v1H6zM9 16h2v1H9zM16 16h5v1H16zM24,16 h1v1H24zM8 17h1v1H8zM11 17h3v1H11zM15 17h2v1H15zM20 17h2v1H20zM23 17h1v1H23zM0 18h7v1H0zM9 18h2v1H9zM12 18h1v1H12zM14 18h1v1H14zM16 18h1v1H16zM18 18h1v1H18zM20 18h1v1H20zM22 18h2v1H22zM0 19h1v1H0zM6 19h1v1H6zM11 19h1v1H11zM13 19h2v1H13zM16 19h1v1H16zM20 19h1v1H20zM22,19 h3v1H22zM0 20h1v1H0zM2 20h3v1H2zM6 20h1v1H6zM10 20h1v1H10zM12 20h2v1H12zM15 20h6v1H15zM22 20h1v1H22zM24,20 h1v1H24zM0 21h1v1H0zM2 21h3v1H2zM6 21h1v1H6zM8 21h1v1H8zM11 21h2v1H11zM14 21h3v1H14zM18 21h2v1H18zM21 21h1v1H21zM23 21h1v1H23zM0 22h1v1H0zM2 22h3v1H2zM6 22h1v1H6zM9 22h1v1H9zM12 22h2v1H12zM15 22h2v1H15zM18 22h3v1H18zM24,22 h1v1H24zM0 23h1v1H0zM6 23h1v1H6zM9 23h2v1H9zM14 23h1v1H14zM19 23h3v1H19zM24,23 h1v1H24zM0 24h7v1H0zM9 24h1v1H9zM11 24h1v1H11zM16 24h3v1H16zM20 24h1v1H20zM22 24h1v1H22zM24,24 h1v1H24z"
            ...
            <g fontWeight="800" fontFamily="微软雅黑" fill="#000000">
              ...
              <text x='322' y='98' dominantBaseline="middle" textAnchor="middle" fontSize='10' transform='scale(0.8, 1)'>{"${data.Amount ?? ''}"}</text>
              ...
              <text x='334' y='98' dominantBaseline="middle" textAnchor="middle" fontSize='8'>产品规格</text>
              <text x='568' y='98' dominantBaseline="middle" textAnchor="middle" fontSize='10' transform='scale(0.7, 1)'>{"${data.ProductSpec ?? ''}"}</text>
        ...
        <div style={{ boxShadow: '0px 0px 20px 6px rgba(0,0,0,0.2)' }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 720" shapeRendering="crispEdges" width="50mm" height="80mm">
            ...
            <g fontWeight="900" fontFamily="微软雅黑" fill="#000000">
              ...
              <text transform='scale(.8 1)' x="296" y="338" fontSize="28">数量：{"${data.Amount ?? ''}${data.UnitName ?? ''}"}</text>
            ...
            <svg x="135" y="510" width="180" height="180" shapeRendering="crispEdges" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25">
              <rect width="25" height="25" fill="#ffffff"></rect>
              <path
                fill="#000000"
                d="M0 0h7v1H0zM8 0h2v1H8zM11 0h1v1H11zM14 0h1v1H14zM18,0 h7v1H18zM0 1h1v1H0zM6 1h1v1H6zM8 1h2v1H8zM12 1h1v1H12zM16 1h1v1H16zM18 1h1v1H18zM24,1 h1v1H24zM0 2h1v1H0zM2 2h3v1H2zM6 2h1v1H6zM9 2h3v1H9zM14 2h3v1H14zM18 2h1v1H18zM20 2h3v1H20zM24,2 h1v1H24zM0 3h1v1H0zM2 3h3v1H2zM6 3h1v1H6zM8 3h1v1H8zM10 3h1v1H10zM18 3h1v1H18zM20 3h3v1H20zM24,3 h1v1H24zM0 4h1v1H0zM2 4h3v1H2zM6 4h1v1H6zM8 4h2v1H8zM12 4h1v1H12zM14 4h1v1H14zM18 4h1v1H18zM20 4h3v1H20zM24,4 h1v1H24zM0 5h1v1H0zM6 5h1v1H6zM8 5h1v1H8zM10 5h1v1H10zM12 5h2v1H12zM18 5h1v1H18zM24,5 h1v1H24zM0 6h7v1H0zM8 6h1v1H8zM10 6h1v1H10zM12 6h1v1H12zM14 6h1v1H14zM16 6h1v1H16zM18,6 h7v1H18zM9 7h1v1H9zM12 7h4v1H12zM3 8h1v1H3zM6 8h1v1H6zM9 8h2v1H9zM12 8h2v1H12zM15 8h1v1H15zM19 8h3v1H19zM23,8 h2v1H23zM4 9h1v1H4zM8 9h5v1H8zM17 9h1v1H17zM19 9h2v1H19zM22 9h1v1H22zM24,9 h1v1H24zM0 10h3v1H0zM5 10h3v1H5zM9 10h2v1H9zM13 10h1v1H13zM15 10h2v1H15zM18 10h3v1H18zM0 11h1v1H0zM2 11h3v1H2zM10 11h1v1H10zM16 11h1v1H16zM19 11h3v1H19zM0 12h2v1H0zM3 12h6v1H3zM11 12h2v1H11zM14 12h2v1H14zM18 12h1v1H18zM20 12h1v1H20zM22 12h1v1H22zM24,12 h1v1H24zM1 13h1v1H1zM3 13h2v1H3zM10 13h1v1H10zM15 13h3v1H15zM21 13h1v1H21zM23,13 h2v1H23zM0 14h1v1H0zM3 14h2v1H3zM6 14h3v1H6zM10 14h1v1H10zM14 14h1v1H14zM21 14h1v1H21zM23 14h1v1H23zM1 15h1v1H1zM5 15h1v1H5zM7 15h1v1H7zM10 15h4v1H10zM15 15h1v1H15zM17 15h3v1H17zM24,15 h1v1H24zM0 16h2v1H0zM3 16h2v1H3zM6 16h2v1H6zM9 16h2v1H9zM16 16h5v1H16zM24,16 h1v1H24zM8 17h1v1H8zM11 17h3v1H11zM15 17h2v1H15zM20 17h2v1H20zM23 17h1v1H23zM0 18h7v1H0zM9 18h2v1H9zM12 18h1v1H12zM14 18h1v1H14zM16 18h1v1H16zM18 18h1v1H18zM20 18h1v1H20zM22 18h2v1H22zM0 19h1v1H0zM6 19h1v1H6zM11 19h1v1H11zM13 19h2v1H13zM16 19h1v1H16zM20 19h1v1H20zM22,19 h3v1H22zM0 20h1v1H0zM2 20h3v1H2zM6 20h1v1H6zM10 20h1v1H10zM12 20h2v1H12zM15 20h6v1H15zM22 20h1v1H22zM24,20 h1v1H24zM0 21h1v1H0zM2 21h3v1H2zM6 21h1v1H6zM8 21h1v1H8zM11 21h2v1H11zM14 21h3v1H14zM18 21h2v1H18zM21 21h1v1H21zM23 21h1v1H23zM0 22h1v1H0zM2 22h3v1H2zM6 22h1v1H6zM9 22h1v1H9zM12 22h2v1H12zM15 22h2v1H15zM18 22h3v1H18zM24,22 h1v1H24zM0 23h1v1H0zM6 23h1v1H6zM9 23h2v1H9zM14 23h1v1H14zM19 23h3v1H19zM24,23 h1v1H24zM0 24h7v1H0zM9 24h1v1H9zM11 24h1v1H11zM16 24h3v1H16zM20 24h1v1H20zM22 24h1v1H22zM24,24 h1v1H24z"
