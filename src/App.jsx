  ...
  return <div className="fixed top-0 bottom-0 left-0 right-0 overflow-hidden" ref={eventArea}>
    <div ref={ref} style={{ transformOrigin: '0 0' }}>
      <div className='flex flex-col items-center gap-24px'>
        ...
        <div style={{ boxShadow: '0px 0px 20px 6px rgba(0,0,0,0.2)' }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 500" shapeRendering="crispEdges" width="450" height="500">
            ...
            <g fontWeight="700" fontFamily="微软雅黑" fill="#000000">
              ...
              <text x="20" y="186" fontSize="16">生产车间</text>
              <text x="112" y="186" fontSize="16"></text>
              <line x1="112" y1="190" x2="220" y2="190" stroke="#000000" strokeWidth="2" />
              <text x="235" y="186" fontSize="16">班次</text>
              <text x="294" y="186" fontSize="16"></text>
              <line x1="294" y1="190" x2="406" y2="190" stroke="#000000" strokeWidth="2" />

              <text x="20" y="236" fontSize="16">产品名称</text>
              <text x="112" y="236" fontSize="16"></text>
              <line x1="112" y1="240" x2="220" y2="240" stroke="#000000" strokeWidth="2" />
              <text x="235" y="236" fontSize="16">图号</text>
              <text x="294" y="236" fontSize="16"></text>
              <line x1="294" y1="240" x2="406" y2="240" stroke="#000000" strokeWidth="2" />

              <text x="20" y="286" fontSize="16">本道工序</text>
              <text x="112" y="286" fontSize="16"></text>
              <line x1="112" y1="290" x2="406" y2="290" stroke="#000000" strokeWidth="2" />

              <text x="20" y="336" fontSize="16">送检单位</text>
              <text x="112" y="336" fontSize="16"></text>
              <line x1="112" y1="340" x2="406" y2="340" stroke="#000000" strokeWidth="2" />

              <text x="20" y="386" fontSize="16">操作工</text>
              <text x="112" y="386" fontSize="16"></text>
              <line x1="112" y1="390" x2="406" y2="390" stroke="#000000" strokeWidth="2" />

              <text x="20" y="436" fontSize="16">送检时间</text>
              <text x="112" y="436" fontSize="16"></text>
              <line x1="112" y1="440" x2="406" y2="440" stroke="#000000" strokeWidth="2" />
            </g>
          </svg>
        </div>
        ...
        <div style={{ boxShadow: '0px 0px 20px 6px rgba(0,0,0,0.2)' }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 306" shapeRendering="crispEdges" width="450" height="306">
            ...
            <g fontWeight="700" fontFamily="微软雅黑" fill="#000000">
              ...
              <text x="24" y="164" fontSize="20">名称</text>
              <text x="70" y="164" fontSize="20"></text>
              <line x1="70" y1="168" x2="170" y2="168" stroke="#000000" strokeWidth="2" />
              <text x="174" y="164" fontSize="20">图号</text>
              <text x="220" y="164" fontSize="20"></text>
              <line x1="220" y1="168" x2="350" y2="168" stroke="#000000" strokeWidth="2" />

              <text x="24" y="224" fontSize="20">数量</text>
              <text x="70" y="224" fontSize="20"></text>
              <line x1="70" y1="228" x2="170" y2="228" stroke="#000000" strokeWidth="2" />
              <text x="174" y="224" fontSize="20">批次</text>
              <text x="220" y="224" fontSize="20"></text>
              <line x1="220" y1="228" x2="350" y2="228" stroke="#000000" strokeWidth="2" />

              <text x="24" y="284" fontSize="20">供应商</text>
              <text x="90" y="284" fontSize="20"></text>
              <line x1="90" y1="288" x2="170" y2="288" stroke="#000000" strokeWidth="2" />
              <text x="174" y="284" fontSize="20">生产日期</text>
              <text x="258" y="284" fontSize="20"></text>
              <line x1="258" y1="288" x2="350" y2="288" stroke="#000000" strokeWidth="2" />
            </g>
          </svg>
        </div>
        ...
        <div style={{ boxShadow: '0px 0px 20px 6px rgba(0,0,0,0.2)' }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 306" shapeRendering="crispEdges" width="450" height="306">
            ...
            <g fontWeight="700" fontFamily="微软雅黑" fill="#000000">
              <text fontWeight="800" x="225" y="32" dominantBaseline="middle" textAnchor="middle" fontSize="13">建新赵氏科技有限公司减震骨架生产工序流转卡</text>
              ...
              <text x='112' y='74' dominantBaseline="middle" textAnchor="middle" fontSize='8'></text>

              <text x='38' y='98' dominantBaseline="middle" textAnchor="middle" fontSize='8'>生产批次</text>
              <text x='112' y='98' dominantBaseline="middle" textAnchor="middle" fontSize='8'></text>

              <text x='183' y='74' dominantBaseline="middle" textAnchor="middle" fontSize='8'>物料编码</text>
              <text x='258' y='74' dominantBaseline="middle" textAnchor="middle" fontSize='8'></text>

              <text x='183' y='98' dominantBaseline="middle" textAnchor="middle" fontSize='8'>数量</text>
              <text x='258' y='98' dominantBaseline="middle" textAnchor="middle" fontSize='8'></text>

              <text x='334' y='74' dominantBaseline="middle" textAnchor="middle" fontSize='8'>物料名称</text>
              <text x='398' y='74' dominantBaseline="middle" textAnchor="middle" fontSize='8'></text>

              <text x='334' y='98' dominantBaseline="middle" textAnchor="middle" fontSize='8'>产品图号</text>
              <text x='398' y='98' dominantBaseline="middle" textAnchor="middle" fontSize='8'></text>
              ...
              <text x='112' y='146' dominantBaseline="middle" textAnchor="middle" fontSize='8'></text>

              <text x='38' y='170' dominantBaseline="middle" textAnchor="middle" fontSize='8'>2</text>
              <text x='112' y='170' dominantBaseline="middle" textAnchor="middle" fontSize='8'></text>

              <text x='38' y='194' dominantBaseline="middle" textAnchor="middle" fontSize='8'>3</text>
              <text x='112' y='194' dominantBaseline="middle" textAnchor="middle" fontSize='8'></text>

              <text x='38' y='218' dominantBaseline="middle" textAnchor="middle" fontSize='8'>4</text>
              <text x='112' y='218' dominantBaseline="middle" textAnchor="middle" fontSize='8'></text>

              <text x='38' y='242' dominantBaseline="middle" textAnchor="middle" fontSize='8'>5</text>
              <text x='112' y='242' dominantBaseline="middle" textAnchor="middle" fontSize='8'></text>

              <text x='38' y='266' dominantBaseline="middle" textAnchor="middle" fontSize='8'>6</text>
              <text x='112' y='266' dominantBaseline="middle" textAnchor="middle" fontSize='8'></text>
